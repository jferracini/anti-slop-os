...
> Single source of truth for craft rules. Do not duplicate in SKILL.md, .cursorrules or CLAUDE.md — those files only point here.

## TYPOGRAPHY

- BANNED as default: Inter, Roboto, Arial, Space Grotesk, DM Sans
- BANNED: monospace as decorative aesthetic without semantic function
- BANNED: body text below 15px in reading contexts
- REQUIRED: justify font choice in 1 line before using
- REQUIRED: scale with a defined ratio (1.25 / 1.414 / 1.618 — pick one)
...
- BANNED: margin/padding outside the system
- Vertical rhythm must be auditable
- Intentional breathing room is not random empty space
...
- Grid-breaking with purpose > safe layout

## MOTION

- BANNED: fade-in as default without intention
...
If you cannot answer all 3: do not deliver. Restructure.
